...
const PROFILE = {
    ...
    role: '2nd Year B.Tech Student | Developer | Problem Solver',
    about: [
...
class TerminalApp {
    ...
    printWelcome() {
        this.printBlock([
            this.makeScrollingPre(BANNER_ASCII, 'ascii-banner'),
            this.makeLine('Welcome to the terminal portfolio.', 'text-green'),
            this.makeLine('This build is tuned for crisp monospace rendering and command-first navigation.', 'text-comment')
        ]);
    }
